...
struct NxsStringEqual {
    using first_argument_type = NxsString;
    using second_argument_type = NxsString;
...
inline NxsString &NxsString::operator=(
  const char *s)	/* the string for comparison */
	...
	// SECURITY FIX: Replace sprintf with snprintf - see line below
...
/*!
	Uses standard C function snprintf to append the unsigned integer `i' to the stored string (format code %u).
*/
inline NxsString& NxsString::operator+=(
...
/*!
	Uses standard C function snprintf to append the long integer `l' to the stored string (format code %ld).
*/
inline NxsString& NxsString::operator+=(
...
/*!
	Uses standard C function snprintf to append the unsigned long integer `l' to the stored string (format code %lu).
*/
inline NxsString& NxsString::operator+=(
